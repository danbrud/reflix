...
class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      users: [
        { name: "Danny", backgroundColor: "#03B5AA", budget: 10 },
        { name: "Tal", backgroundColor: "#59114D", budget: 15 },
        { name: "Sammy", backgroundColor: "#E98A15", budget: 17 },
        { name: "Tammy", backgroundColor: "#157F1F", budget: 18 }
      ],
      budget: 10.00
    }
  }
  ...
  updateBudget = (id) => {
      ...
      movie.isRented ? this.setState({budget: currentBudget + 3}) : this.setState({budget: - 3})
    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route exact path='/catalog' render={() => <Catalog movies={movies} updateRented={this.updateRented} updateBudget={this.updateBudget} budget={this.state.budget}/>} />
